                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4  col-md-7 col-sm-6 col-6 order-2 order-sm-3">
                        <div class="appie-btn-box text-right">
                            <a class="login-btn" href="login"><i class="fal fa-user"></i> Login</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="appie-hero-content">
                        <h1 class="appie-title">Personal Finance Tracking.</h1>
                ...
                <div class="col-lg-6">
                    <div class="appie-hero-thumb">
                        <div class="thumb">
                            <img src="https://i.imgur.com/eKwFXqB.png" alt="" style="width: 300px;">
                        </div>
                    </div>
                </div>
            </div>
